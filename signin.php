			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-37 p-b-30">
				<form class="login100-form validate-form" method='POST'>
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" id='uname' name="uname" placeholder="Username" required>
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Password is required">
						<input class="input100" type="password" name="pword" id='pword' placeholder='Password' required>
						<span class="focus-input100"></span>
						<span class="symbol-input100">
